...
public class ChangeCredentialsConfiguratorController  {
    ...
    public ChangeCredentialsConfiguratorController (ChangeCredentialsConfiguratorView changeCredentialsConfiguratorView, ConfiguratorController configuratorController,  SubjectController subjectController, SessionController sessionController, ClientClasse client )
    {
