...
import Request.SomeRequestConversionFactors;
import Request.DTO.ConversionFactorDTO;
import Request.DTO.ConversionFactorsDTO;
...
public class ConversionFactorsController  {
    ...
    public ConversionFactorsController ( AllConversionFactorsView allConversionFactorsView, InsertConversionFactorsView insertConversionFactorsView, ConversionFactorsOfCategoryView conversionFactorsOfCategoryView, ConversionFactorController conversionFactorController, CategoryController categoryController, ControlPatternController controlPatternController, SessionController sessionController, ClientClasse client)
    {
